...
const ConsulSchedule = () => {
        ...
        if (true /*displayMode === "calender"*/) {
            return (
                <div className='clt_schedule-mode-btn'>
                    <button className='clt_schedule-mode-btn-calender' onClick={handleCalenderBtnOnclick} >
                        <img className='clt_schedule-mode-calender-icon' src={calenderIcon} />
                        <span className='clt_schedule-mode-calender-text'>行事曆</span>
                    </button>
                    <button className='clt_schedule-mode-btn-list' onClick={handleListBtnOnclick} >
            ...
            return (
                <div className='clt_schedule_mode_btn' style={{display: 'flex'}}>
                    <button onClick={handleCalenderBtnOnclick} style={{color: 'cyan'}}>Calender</button>
                    <button onClick={handleListBtnOnclick} style={{color: 'blue'}}>List</button>
                </div>
            )
        }
    }
    ...
    return (
        <div className='clt_schedule-main'>
            ...
            {modeBtn()}
            <div className='clt_schedule-display'>  
                {showSchedule()}
            </div>
        </div>
    )
