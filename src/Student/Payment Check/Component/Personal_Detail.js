      ...
      <div className="std_personal-details" aria-label="details">
        <div className="std_personal-details-line" aria-label="first line">
          <div className="std_personal-details-left" aria-label="time component">
            <img className="std_personal-detail-icon" src={Clock} alt="clock"></img>
          ...
          <div aria-label="arctics account">
            <img className="std_personal-detail-icon" src={Account} alt="credit card"></img>
            <span className="std_personal-detail-title">Arctics帳號</span>
            <span className="std_personal-detail-content">{dummy.accountNo}</span>
          </div>
        </div>
        <div className="std_personal-details-line" aria-label="second line">
          <div className="std_personal-details-left" aria-label="consultant">
            <img className="std_personal-detail-icon" src={Consultant} alt="consultant"></img>
            <span className="std_personal-detail-title">顧問</span>
            <span className="std_personal-detail-content">
              {dummy.consultantSurname}{dummy.consultantFirstname}同學<br/></span>
            <span className="std_personal-detail-content-2ndrow">{dummy.consultantSchool} {dummy.consultantMajor}</span>
          </div>
          <div aria-label="discount code">
            <img className="std_personal-detail-icon" src={Coupon} alt="coupon"></img>
        ...
        <div className="std_personal-details-line" aria-label="third line">
          <div className="std_personal-details-left" aria-label="consultant">
            <img className="std_personal-detail-icon" src={Money}  alt="money"></img>
            <span className="std_personal-detail-title">計價</span>
            <span className="std_personal-detail-content">{dummy.actualPrice}/0.5hr</span>
          </div>
        </div>
      </div>
      <div className="std_personal-details-bottom-container">
        <p><img src={Money} alt="money" />總金額<span>{dummy.actualPrice}</span>元</p>
        <button>確認預約</button>
      </div>
    </div>
  );
