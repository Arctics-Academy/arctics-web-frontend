    ...
    <div className="App">
      <ContextReducer>
        ...
        <Switch>
          ...
          <Route
            exact
            path="/register-mobile-otp"
            component={RegisterMobileOTP}
          />
          <Route
            exact
          ...
          <Route
            exact
            path="/consultant-schedule/:mode"
            component={ConsulSchedule}
          />
          <Route exact path="/consultant-purse/:mode" component={ConsulPurse} />
          <Route
            exact
            path="/consultant-success-cancel"
            component={ConsulCancelSuccess}
          />
          <Route
            exact
            path="/consultant-multi-cancel"
